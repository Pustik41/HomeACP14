...
// @BeforeClass -> connecto to the 'test base' and create schema(tables)
// before init data, fill in tables
// test
...
// after clear all data
// ..
// AfterClass remove test schemas
public class StudentDaoTest {
    ...
    public void rateStudentBySubject() throws Exception {
        List<Integer> subject_id = new GroupDao(connection).getGroupSubjects_id(1);
